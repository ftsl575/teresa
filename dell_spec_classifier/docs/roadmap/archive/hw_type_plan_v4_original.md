...
```
ПРОЕКТ: teresa / dell_spec_classifier
ФАЙЛЫ: golden/dl1_expected.jsonl, tests/test_stats_hw_type.py
...
ACCEPTANCE:
- pytest tests/ -v — 0 failures.
- golden содержит hw_type.
- Тест проверяет точные counts.
